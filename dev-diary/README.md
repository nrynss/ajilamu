...
| P6 | 5 / 7 | In progress. T6.1, T6.2, T6.4, T6.5a and T6.6 approved with zero residue. T6.3 and T6.5 remain. See [t6.5a-round2.md](adversarial-review/t6.5a-round2.md). |
