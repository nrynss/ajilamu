...
| P6 | 8 / 9 | In progress. T6.1, T6.2, T6.3, T6.4, T6.5, T6.5a, T6.5b and T6.6 approved with zero residue. T6.5c remains. See [t6.5-round5.md](adversarial-review/t6.5-round5.md). |
