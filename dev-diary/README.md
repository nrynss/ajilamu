...
**Current status:** P6 is closed. P5 close review approved with zero residue. P7 close review approved. P8 Ship has started. The live end-to-end run found a stale ledger schema, now provisioned, and two code defects under remediation.
...
P6 closed on 2026-09-09 after eight close rounds. The live T8.1 run then found a stale
ClickHouse Cloud schema, now provisioned as the `ajilamu` database, plus two code defects
under remediation.
