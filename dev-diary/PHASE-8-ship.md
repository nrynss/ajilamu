...
`docs/submission.md` is written. Every number names the record that measured it.

The recording rig lives in the user's own shoot folder, so this repository carries no runbook.
